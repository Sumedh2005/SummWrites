...
function Y2sn() {
  ...
  return (
    <div className={`${darkMode ? 'dark' : ''}`}>
      <div className="bg-[url('/bg1.svg')] dark:bg-[url('/dbg2.svg')] pt-6 px-5 font-ubuntu">
        {/* Title */}
        <div className="flex justify-center mr-16">
          <div className="text-center text-or1 dark:text-gray-100 font-semibold pt-10 ml-16 md:ml-0 h-28 rounded-3xl md:w-[450px] w-[350px] text-2xl">
            Year 2 [Short Notes]
          </div>
        </div>
                    ...
                    <ul className="flex md:flex-row flex-col md:space-x-6 gap-y-2 ml-16 md:ml-0 mt-4">
                      {subject.notes.map((note, index) => (
                        <li key={index} className="flex-shrink-0">
                          ...
                          >
                            <div className="n font-ubuntu h-20 font-medium text-xl border-[#008080] dark:border-gray-400 border-[2px] pt-5 rounded-2xl text-center p-2 w-48 md:w-48 hover:text-white hover:bg-[#008080] ">
                              {note.name}
                            </div>
                          </a>
                        </li>
