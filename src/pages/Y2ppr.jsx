    ...
    <div className={`${darkMode ? 'dark' : ''}`}>
      <div className="bg-[url('/bg1.svg')] dark:bg-[url('/dbg2.svg')] pt-6 px-5 pb-10  font-ubuntu">
        ...
        <div className="flex justify-center mr-16">
          <div className="text-center text-or1 dark:text-gray-100  font-semibold pt-10 ml-16 md:ml-0 h-full pb-10 rounded-3xl md:w-[450px] w-[350px] text-3xl">
            Year 2 [UT pprs]
          </div>
        </div>

        <p className="my-2 text-2xl pb-2 font-normal text-center text-or1 dark:text-gray-100">
                    ...
                    <ul className="flex md:flex-row flex-col md:space-x-6 gap-y-2 ml-16 md:ml-0 mt-4">
                      {subject.notes.map((note, index) => (
                        <li key={index} className="flex-shrink-0">
                          ...
                          >
                            <div className="n font-ubuntu h-20 font-medium text-xl border-[#008080] dark:border-gray-400 border-[2px] pt-6 rounded-2xl text-center p-2 w-48 md:w-36 hover:text-white hover:bg-[#008080] dark:hover:bg-gray-700">
                              {note.name}
                            </div>
                          </a>
                        </li>
