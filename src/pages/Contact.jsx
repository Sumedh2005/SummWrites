        ...
        <div className="lft flex flex-col mb-20 md:ml-40 mt-10 space-y-6 border-r-0 lg:border-r-[3px] lg:pr-40 lg:mr-40 border-or1 items-center lg:items-start mx-auto">
          ...
          <div className="h-16 border-[1px] border-or1 rounded-2xl w-[90%] lg:w-[396px] flex items-center px-6 space-x-4">
            <input
              ...
              className="flex-1 placeholder:text-[#c5c5c5] text-lg text-or1 focus:outline-none"
            />
          ...
          {/* Message Input */}
          <div className="h-48 border-[1px] border-or1 text-or1 rounded-2xl w-[90%] lg:w-[396px] flex flex-col items-start px-6 py-4">
            <textarea
              name="message"
              value={formData.message}
              onChange={handleChange}
              placeholder="Write your message here"
              className="w-full h-44 placeholder:text-[#c5c5c5] text-lg focus:outline-none"
            />
          </div>
